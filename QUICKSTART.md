...
- `the snare line held a catch overnight: 1 raw meat` — **the living details** (Wave N): traps and fish baskets catch food while everyone sleeps, herbs pound into healing poultices, burial rites soften grief, hives give honey, the press gives wine, shells become bead necklaces, an ox-cart quickens the walk, and the market stall sells for coin.
- `Sela dug a grave and laid Toran to rest` — **the dead do not lie forever**: a body stays where it fell, and a villager who knows Burial of the dead (E2.24) will dig a grave — an earth mound and headstone you can click to see who rests there and who buried them. Left unburied for 3 days, `scavengers scattered the bones` and nothing marks the spot. In emergent games nobody knows the rite at first; the dead simply lie there until someone works out what to do with them.
- `Aut printed a book of their finest knowledge` — **the press** (Wave L): books carry a real technology; whoever reads one *learns it* — knowledge that outlives its author and travels by trade, gift, inheritance… or raid. Plus: heavy plows behind oxen double harvests, the blast furnace pours the best tools in the game, the university doubles down on teaching, and the clock tower quickens the whole village.
- `Kara soaked away the aches at the bathhouse` / `spent the evening at the theater and feels merry` — **civic stone** (Wave K): concrete raises buildings that quietly help everyone near them; the ice house never spoils, the fountain lets the village grow larger, and a **stone wall** keeps wolves out entirely and shuts out most raids.
